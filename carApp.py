...
with open('C:\\Users\\Hp\\Desktop\\programs\\ML\\car price prediction\\carModel.pkl', 'rb') as model_file:
...
if st.button('Predict Price'):
    input_features = [[selected_name,selected_company,selected_year,km_driven,selected_fuel_type]]
